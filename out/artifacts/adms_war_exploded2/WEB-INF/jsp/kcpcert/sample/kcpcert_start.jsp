...
<%
    ...
    String site_cd   = "A7XRC"; // 테스트:S6186, 포항공대:A7XRC
...
<html>
    <head>
        ...
        <link href="/static/kcpcert/css/sample.css" rel="stylesheet" type="text/css">
        <script type="text/javascript">
            ...
            function auth_type_check()
            {
                ...
                else
                {
                    ...
                    auth_form.action = "./reqForm"; // 인증창 호출 및 결과값 리턴 페이지 주소
        ...
        <div align="center">
            <form name="form_auth">
                <table width="589" cellpadding="0" cellspacing="0">
                    <tr style="height:14px"><td style="background-image:url('/static/kcpcert/img/boxtop589.gif');"></td></tr>
                    <tr>
                        <td style="background-image:url('/static/kcpcert/img/boxbg589.gif')">
        
                            <!-- 상단 테이블 Start -->
                            <table width="551px" align="center" cellspacing="0" cellpadding="16">
                                <tr style="height:17px">
                                    <td style="background-image:url('/static/kcpcert/img/ttbg551.gif');border:0px " class="white">
                                        <span class="bold big">[인증요청]</span> 이 페이지는 휴대폰 인증요청 페이지입니다.
                                    </td>
                                </tr>
                                <tr>
                                    <td style="background-image:url('/static/kcpcert/img/boxbg551.gif') ;">
                                        <p class="align_left">소스 수정 시 가맹점의 상황에 맞게 적절히 수정 적용하시길 바랍니다.</p>
                                        <p class="align_left">결제에 필요한 정보를 정확하게 입력하시어 인증를 진행하시기 바랍니다.</p>
                                    </td>
                                </tr>
                                <tr style="height:11px"><td style="background:url('/static/kcpcert/img/boxbtm551.gif') no-repeat;"></td></tr>
                            </table>
                            <!-- 상단 테이블 End -->
                            ...
                            <table width="527" align="center" cellspacing="0" cellpadding="0" class="margin_top_20">
                                ...
                                <tr>
                                    ...
                                    <td class="sub_content1"><input type="text" name="user_name" value="김형국" size="20" maxlength="20" class="frminput" /></td>
                                </tr>
                                <!-- 생년월일 -->
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="sub_content1 bold">
                                        <input type="radio" name="sex_code" value="01" checked="checked"/>남성
                            ...
                            <table width="527" align="center" cellspacing="0" cellpadding="0" class="margin_top_20">
                                ...
                                <tr id="show_pay_btn">
                                    <td colspan="2" align="center">
                                        <input type="image" src="/static/kcpcert/img/btn_certi.gif" onclick="return auth_type_check();" width="108" height="37" alt="결제를 요청합니다" />
                                    </td>
                                </tr>
                            </table>
                            <!-- 결제 버튼 테이블 End -->
                    ...
                    <tr><td><img src="/static/kcpcert/img/boxbtm589.gif" alt="Copyright(c) KCP Inc. All rights reserved."/></td></tr>
                </table>
                ...
                <input type="hidden" name="Ret_URL"      value="http://localhost/kcpCert/reqForm" />
