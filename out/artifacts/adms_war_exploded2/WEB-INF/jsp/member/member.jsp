...
function initialGrid(){
	...
	var memberGrid = $("#list").kendoGrid({
        ...
        columns: [
	        ...
	        {command: { click: openUpdateForm, name: "btnUpdate", text: "<img src='/static/images/btn_write.png' height='24' width='24'>" },title:"수정",width:100,attributes: { style: "text-align: center;" },headerAttributes: {style:"font-weight:bold;font-size: 12px;text-align: center;"}}
        ]
    });
	...
	<div class="searchBox">
		...
		<div class="optionBox">
			...
			<input id="userName" type="text" name="userName" value="" class="k-textbox" >
		     -->
			<label class="pl40" style="width:100px;">회원명</label>
			<input type="text" id="name" name="name" class="k-textbox" />
            <label class="pl40" style="width:100px;">입학년도</label>
            <input type="text" id="searchEntranceYear" name="searchEntranceYear" class="k-textbox" />
			<br />
            <label class="pl40" style="width:100px;">학과</label>
            <select name="searchDept" id="searchDept" style="width:160px" ${userInfo.groupId gt 3? 'disabled' : ''}>
