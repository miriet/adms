...
<script>
    ...
    function deleteDegreeRow(obj){
      ...
      if (_id == "undefined" || _id == null || $.trim(_id) == "") {
          ...
          $.ajax({
              url: '/myuser/delete/' + _id + "/degreeInfo",
    ...
    function deleteAddressRow(obj){
      ...
      if (_id == "undefined" || _id == null || $.trim(_id) == "") {
          ...
          $.ajax({
              url: '/myuser/delete/' + _id + "/addressInfo",
              success : function(data){
                  $(obj).closest("tr").remove();
                  alert("삭제되었습니다.");
              },
...
<body class="index">
    ...
    <table id="addressInfo" class="table_sc">
        ...
        <tr height="15px" class="TBC_th">
            ...
            <th data-field="addresses.address1" class="TBC_th" style="width:17%">주소1</th>
            <th data-field="addresses.address2" class="TBC_th" style="width:17%">주소2</th>
            <th data-field="addresses.address3" class="TBC_th" style="width:17%">주소3</th>
