...
<body class="index">
        ...
        <tr height="24px">
            ...
            <td class="TBC_td">
                <select name="mailingAddress" style="width:98%">
                    <option <c:if test="${result.mailingAddress == 'HOME' }">selected</c:if> value="HOME">자택</option>
                    <option <c:if test="${result.mailingAddress == 'WORK' }">selected</c:if> value="WORK">직장</option>
                </select>
            </td>
        </tr>
        <tr height="24px">
    ...
    <table id="addressInfo" class="table_sc">
        ...
        <tr height="15px" class="TBC_th">
            ...
            <th data-field="addresses.address1" class="TBC_th" style="width:15%">시/도, 구/군</th>
            <th data-field="addresses.address2" class="TBC_th" style="width:15%">도로명</th>
            <th data-field="addresses.address3" class="TBC_th" style="width:15%">상세주소</th>
