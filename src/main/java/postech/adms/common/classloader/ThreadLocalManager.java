package postech.adms.common.classloader;
...
public class ThreadLocalManager {
    ...
    public static void addThreadLocal(@SuppressWarnings("rawtypes") ThreadLocal threadLocal) {
        Long position;
    ...
    public static void remove() {
        for (@SuppressWarnings("rawtypes") Map.Entry<Long, ThreadLocal> entry : THREAD_LOCAL_MANAGER.get().threadLocals.entrySet()) {
